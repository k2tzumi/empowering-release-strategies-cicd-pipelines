...
<!--
定期リリースを行っていてリリース前にQAテストが入るようなものをイメージしています
-->
...
<!--
扱う領域が広くなって組織もアプリも複雑になってリリースも複雑化する  
全体を俯瞰できる人のみが許される
-->
...
# セマンティックバージョニングとは？
 バージョン番号(`<major> "." <minor> "." <patch>`)間で互換性を表す
...
* リリースマネジメントが民主化される  
次回のリリース内容が見えるようになって、各チーム間でいい感じに協調できる
...
* ログに API のバージョンが表示されて良い  
古いバージョン使っていてエラーになっているのが直ぐにわかる
